...
export const runKintsugiTask = async () => {
    ...
    const res = await axios.get("https://kintsugi.interlay.io/marketdata/price?vs_currencies=usd&ids=bitcoin,bitcoin,kintsugi,kusama,acala-dollar,liquid-ksm,tether")
